...
def team_status(root: Path, season: str, team_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "roster_verification": find_team_row(rows["raw/team_roster_verification.csv"], team_id) is not None,
        "schedule_environment": find_team_row(rows["raw/team_schedule_environment.csv"], team_id) is not None,
        "schedule_recommendations": find_team_row(rows["processed/team_schedule_recommendations.csv"], team_id) is not None,
