...
Use these when asking Codex or another coding agent to work in the repo.
...
Human docs should explain how to use or reason about TierForge.

Agent docs may contain implementation plans, prompt templates, or task-specific notes that help an agent make changes safely.
